...
lebanon = Country("Lebanon", "Asia", "Warm", "Arabic")

print(lebanon.continent)
...
beirut = City("Beirut", "Lebanon", "Asia", "Warm", "Arabic")
...
divisibleby3and4= []
for n in list_of_numbers:
    if Number(n).divisible_by_n(3 and 4):
        divisibleby3and4.append(n)

print(divisibleby3and4)
# -------------------------------------------------------------------------------------- #
